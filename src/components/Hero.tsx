      ...
      <div className="relative z-10 flex min-h-screen items-center">
        <div className="container mx-auto px-4 py-20 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-6">
            <InteractiveHoverButton to="/contact" text="Enroll Now" className="bg-[#d79017] text-[#1a2b3d] border-[#d79017] hover:text-[#1a2b3d] w-64 h-16 text-lg !p-4 !rounded-2xl shadow-[0_12px_30px_rgba(215,144,23,0.38)]" />
