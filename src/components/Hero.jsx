    ...
    <section id="home" className="relative min-h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${heroBg})` }}>
      ...
      <div className="absolute inset-0 bg-black/50"></div>
        ...
        <div className="container mx-auto px-4 text-center py-20">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-white drop-shadow-lg font-hero leading-tight tracking-wider transform-gpu transition-transform duration-300 hover:-translate-y-1 hover:scale-105">Arise and Shine Football Academy</h1>
